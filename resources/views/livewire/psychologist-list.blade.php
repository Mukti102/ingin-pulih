            ...
            <div class="flex flex-col lg:flex-row gap-4 mb-10">
                ...
                <div class="relative w-full lg:w-3/4 group">
                    ...
                    <div class="flex gap-2">
                        ...
                        {{-- <button
                            class="w-14 h-14 bg-brand-600 text-white rounded-2xl flex items-center justify-center shadow-sm shadow-brand-200 hover:bg-brand-700 active:scale-95 transition-all">
                        ...
                        <div
                            ...
                            <div class="flex flex-col md:flex-row md:items-center gap-6 p-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <h3
                                        class="text-xl font-bold text-gray-900 mb-1 group-hover:text-brand-600 transition-colors">
                                        {{ $psikolog->fullname }}
                                    </h3>

                                    <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 mt-3">
                                        <span class="flex items-center gap-1"><i
                                                class="fas fa-briefcase text-brand-300"></i>
                                            {{ $psikolog->experience_years }} Tahun</span>
                                        <span class="flex items-center gap-1"><i
                                                class="fas fa-comment-dots text-brand-300"></i> 500+ Sesi</span>
                                        <span class="flex items-center gap-1 text-yellow-500 font-bold"><i
                                                class="fas fa-star"></i> 4.9 (112)</span>
                                    </div>
                                            ...
                                            <span class="font-bold text-gray-900">
                                                @php
                                                    ...
                                                    if ($this->day) {
                                                        ...
                                                        $this->selectedDate &&
                                                        !str_contains($this->selectedDate, ' to ')
                                                    ) {
                                                        $targetDay = strtolower(
                                                            \Carbon\Carbon::parse($this->selectedDate)->format('l'),
                                                        );
                                                    }
                                                    ...
                                                    if ($targetDay) {
                                                        ...
                                                        if ($schedule) {
                                                            $displaySchedule =
                                                                \Carbon\Carbon::parse($schedule->start_time)->format(
                                                                    'H:i',
                                                                ) .
                                                                ' - ' .
                                                                \Carbon\Carbon::parse($schedule->end_time)->format(
                                                                    'H:i',
                                                                ) .
                                                                ' WIB';
                                                        } else {
                                ...
                                <div
                                    class="md:border-l border-gray-200 md:pl-8 flex flex-col items-center justify-center">
                                    <a href="{{ route('detail.psikolog', encrypt($psikolog->id)) }}"
                                        class="w-full md:w-auto px-7 py-2 bg-orange-500 text-white text-sm font-bold rounded-2xl hover:bg-brand-600 transition-all shadow-sm shadow-gray-200">
                                        Booking Sesi
                                    </a>
                                </div>
                            </div>
